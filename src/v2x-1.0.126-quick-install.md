...
- enter your openv2x external ip
...
- OpenV2X Edge Portal(Edgeview)：`http://<external-ip>` 用户名：admin，密码：dandelion
- OpenV2X Central Portal(Centerview)：`http://<external-ip>:8080` 用户名：admin，密码：dandelion
